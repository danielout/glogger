        ...
        <template v-if="matchingGifts.length">
          <div class="flex flex-col gap-0.5 px-2">
            <div
              ...
              :key="gift.itemName"
              class="flex items-center gap-2 text-xs bg-surface-inset rounded px-2 py-0.5">
              ...
              <span class="text-value-positive text-[0.6rem] font-mono shrink-0">+{{ gift.prefValue }}</span>
            </div>
          </div>
