<template>
  <div v-if="preferences.length" class="flex flex-col gap-1.5">
    ...
    <!-- Gift tier unlocks -->
    <div v-if="npc.gift_favor_tiers?.length" class="text-[10px] text-text-dim px-2 mb-1">
      Gifting unlocked at:
    ...
    <div class="flex flex-col gap-0.5">
      <div
        ...
        <!-- Desire badge -->
        <span
          class="text-[10px] px-1.5 py-0.5 rounded border min-w-10 text-center shrink-0"
