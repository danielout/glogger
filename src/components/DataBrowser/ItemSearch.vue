      ...
      <div class="flex flex-col gap-2 h-full overflow-hidden">
          ...
          <div class="flex items-center gap-2">
            ...
            <div class="flex-1 relative" v-if="!filterKeyword">
              ...
              <div
                ...
                <div
                  ...
                  :key="kw"
                  class="px-2 py-1 cursor-pointer text-[0.72rem] hover:bg-surface-row-hover"
            ...
            <div v-else class="flex items-center gap-1 flex-1">
              <span
                ...
                :class="filterKeyword.startsWith('Lint_') ? 'bg-[#1e1a10] border-[#3a3010] text-[#887040]' : 'bg-surface-card border-border-subtle text-[#7ec8e3]'">
                {{ filterKeyword }}
              </span>
              <button
        ...
        <ul v-else ref="listRef" class="list-none m-0 p-0 overflow-y-auto flex-1 border border-surface-elevated">
          <li
            ...
            :class="{ 'bg-surface-card border-l-2 border-l-accent-gold': selected?.id === item.id, 'bg-surface-elevated': selectedIndex === idx && selected?.id !== item.id }"
