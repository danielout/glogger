      ...
      <div class="flex flex-col gap-2 h-full overflow-hidden">
        ...
        <ul ref="listRef" v-else class="list-none m-0 p-0 overflow-y-auto flex-1 border border-surface-elevated">
          <li
            ...
            :class="{ 'bg-surface-card border-l-2 border-l-accent-gold': selected?.id === recipe.id, 'bg-surface-elevated': selectedIndex === idx && selected?.id !== recipe.id }"
      ...
      :class="{ 'items-center justify-center': !selected }">
        ...
        <template v-else>
          ...
          <div v-if="selected.ingredients.length" class="flex flex-col gap-1.5">
            ...
            <div class="flex flex-col gap-1">
              <div
                ...
                :key="idx"
                class="flex gap-2 items-center text-sm px-1.5 py-0.5 bg-surface-inset border-l-2"
          ...
          <div v-if="selected.result_items.length" class="flex flex-col gap-1.5">
            ...
            <div class="flex flex-col gap-1">
              <div
                ...
                :key="idx"
                class="flex gap-2 items-center text-sm px-1.5 py-0.5 bg-surface-inset border-l-2 border-l-surface-elevated">
          ...
          <div v-if="recipeCost.breakdown.value" class="flex flex-col gap-1.5">
            ...
            <div class="flex flex-col gap-1">
              <div
                ...
                :key="idx"
                class="flex gap-2 items-center text-xs px-1.5 py-0.5 bg-surface-inset border-l-2"
          ...
          <div v-if="selected.reward_skill" class="flex flex-col gap-1.5">
            ...
            <div class="flex flex-col gap-1">
              <div class="flex gap-2 text-sm px-2 py-1 bg-surface-inset border-l-2 border-l-[#2a4a2a]">
          ...
          <div v-if="selected.prereq_recipe" class="flex flex-col gap-1.5">
            ...
            <div class="text-sm px-2 py-1 bg-surface-inset border-l-2 border-l-[#4a2a2a] text-text-secondary flex items-center gap-1">
